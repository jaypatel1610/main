			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
                     ...
                     <button type="submit" name="signin"  autoComplete="off"  class="btn btn-default">Login</button>
                     
                    <p class ="trct-center">Forgot password🤔?<a href = " recover_email.php">click here?</a></p>
                    </Form>
					</div><!--/login form-->
				</div>
				<div class="col-sm-1">
  ...
  if(isset($_POST['signup'])){
      ...
      else
      {
          ...
          if($iquery)
          {
            ...
            $headers="nencyvpatel3010@gmail.com";
					...
					<div class="signup-form"><!--sign up form-->
						...
						<form method="POST" action="">
							<div class="form-group"> 
							 ...
							 <div class="form-group"> 
								<label htmlFor="password"><i class="zmdi zmdi-lock"></i></label>
								<input type="text" name="password"  autoComplete="off" placeholder="Your Password" class="form-control" required>
								   
								</input>
							   
							 
							 </div>
							 <button type="submit" class="btn btn-default" name="signup"  autoComplete="off">Signup</button>
							</form>
					</div><!--/sign up form-->
				</div>
			</div>
